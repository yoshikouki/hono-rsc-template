...
export const markdownComponents = {
  ...
  h2: (props: Props<"h2">) => (
    <h2 className="mt-10 mb-4 text-2xl font-semibold border-b pb-2" {...props} />
  ),
  h3: (props: Props<"h3">) => (
  ...
  ul: (props: Props<"ul">) => (
    <ul className="mt-4 list-disc pl-6 space-y-1" {...props} />
  ),
  ol: (props: Props<"ol">) => (
    <ol className="mt-4 list-decimal pl-6 space-y-1" {...props} />
  ),
  ...
  pre: (props: Props<"pre">) => (
    <pre className="mt-4 overflow-x-auto rounded border bg-gray-50 p-4 [&>code]:bg-transparent [&>code]:p-0" {...props} />
  ),
  blockquote: (props: Props<"blockquote">) => (
    <blockquote className="mt-4 border-l-4 pl-4 italic text-gray-600" {...props} />
  ),
